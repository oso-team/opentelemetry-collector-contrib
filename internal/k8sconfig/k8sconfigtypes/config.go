...
// Package k8sconfigtypes holds the configuration types for connecting to the
// K8s API. It deliberately has no dependency on k8s.io/client-go (or any
// other Kubernetes SDK) so that config schemas can reference these types
// without pulling the Kubernetes client libraries into their builds. The
// client constructors that consume these types live in the parent k8sconfig
// package, which re-exports the types via aliases.
