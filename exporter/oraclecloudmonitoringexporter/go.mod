module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/oraclecloudmonitoringexporter

go 1.25.0

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/oraclecloudauthextension v0.0.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/extension/oraclecloudauthextension => ../../extension/oraclecloudauthextension
