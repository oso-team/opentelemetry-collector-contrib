...
package config // import "github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourcedetectionprocessor/internal/system/config"
...
var validHostnameSources = map[string]struct{}{
	"os":     {},
	"dns":    {},
	"cname":  {},
	"lookup": {},
...
func (cfg *Config) Validate() error {
	for _, hostnameSource := range cfg.HostnameSources {
		_, exists := validHostnameSources[hostnameSource]
		if !exists {
